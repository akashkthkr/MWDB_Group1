...
class DTUtilities():
    ...
    def save_fp_misses_rate(self):
        ...
        self.save_file(self.false_positive_rate, f"DT_Classifier_fpr_Task{self.task_id}.json")
        self.save_file(self.misses_rate, f"DT_Classifier_mr_Task{self.task_id}.json")
        self.save_file(self.false_positives, f"DT_Classifier_fp_Task{self.task_id}.json")
        self.save_file(self.true_positives, f"DT_Classifier_tp_Task{self.task_id}.json")
        self.save_file(self.false_negatives, f"DT_Classifier_misses_Task{self.task_id}.json")
        self.save_file(self.true_negatives, f"DT_Classifier_tn_Task{self.task_id}.json")
