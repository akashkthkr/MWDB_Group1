...
class DTUtilities():
    ...
    def save_fp_misses_rate(self):
        ...
        self.save_file(false_positives, f"DT_Classifier_fp_Task{self.task_id}.json")
        self.save_file(true_positives, f"DT_Classifier_tp_Task{self.task_id}.json")
        self.save_file(misses, f"DT_Classifier_misses_Task{self.task_id}.json")
